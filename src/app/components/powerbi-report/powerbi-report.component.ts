...
export class PowerBiReportComponent implements OnInit {
  ...
  updateQuestions() {
    const newQuestions = [
      '¿Qué productos o servicios han mostrado las mayores caídas de ventas en el último trimestre y por qué?',
      'Qué clientes muestran el mayor crecimiento en ventas?',
      '¿Cómo ha variado el margen de ganancia entre las diferentes líneas de negocio en los últimos 12 meses?',
      '¿Qué áreas presentan los mayores incrementos en costos y cómo podemos controlarlos?'
    ];
