...
@Component({
  selector: 'app-machines-off-production',
  standalone: true,
  imports: [
    MatToolbarModule,
    MatTableModule,
  ...
  templateUrl: './machines-off-production.component.html',
  styleUrls: ['./machines-off-production.component.css']
})
export class MachinesOffProductionComponent implements OnInit {
