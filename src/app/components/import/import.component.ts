...
const USERS_DATA: UserData[] = [
  ...
  {Formulario: 'Cartera', Carpeta: 'DesempenoFinanciero/', modeldata: '@ModeloCartera', storedprocedure: '[cartera].[ImportCartera]', modelImport: 'ImportModels/ImportModels_Cartera.xlsx'},
  {Formulario: 'Inventario', Carpeta: 'Inventario/', modeldata: '@ModeloInventario', storedprocedure: '[Inventario].[ImportInventario]', modelImport: 'ImportModels/ImportModels_Inventario.xlsx'},
  {Formulario: 'Orden de compra', Carpeta: 'Inventario/', modeldata: '@ModeloOrdenesCompras', storedprocedure: '[Inventario].[ImportOrdenesCompras]', modelImport: 'ImportModels/ImportModels_OrdenCompra.xlsx'},
 ];
